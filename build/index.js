...
class Search {
  ...
  async getResults() {
    try {
      const response = await axios__WEBPACK_IMPORTED_MODULE_0___default().get(data.root_url + '/wp-json/YOURTHEMEPATH/v1/search?term=' + this.searchField.value);
      ...
      /* eslint-disable */;
      oo_oo(), console.log(e, `fc57b2a7_0`);
    }
  }
...
const main = new _modules_Main__WEBPACK_IMPORTED_MODULE_1__["default"]();
})();
